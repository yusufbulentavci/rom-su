...
import com.bilgidoku.rom.base.ilk.util.Assert;
import com.bilgidoku.rom.base.min.Sistem;
import com.bilgidoku.rom.base.min.err.KnownError;
import com.bilgidoku.rom.base.min.gorevli.Astate;
...
public class DbThree implements AutoCloseable, DbSetGet {
	...
	public void setTransactional() throws KnownError {
		try {
			...
			throw vg.errorOccured(connection, "autocommit=false");
		}
	}
	...
	public void commit() throws KnownError {
		try {
			...
			throw vg.errGeneric(connection, "commit", e);
		}
	}
	...
	public void rollback() throws KnownError {
		try {
			...
			throw vg.errorOccured(connection, "rollback");
		}
	}
...
//			return oid;
//		} catch (SQLException e) {
//			throw vg.errGeneric(connection, "insert file", e);
//		}
//	}
//
...
//			}
//		} catch (SQLException e) {
//			throw vg.errGeneric(connection, "get file", e);
//		}
//	}
	...
	private void setQuery(String query) throws KnownError {
		try {
			...
			throw vg.errExecute(connection, query, e);
		}
	}
	...
	public boolean next() throws KnownError {
		...
		try {
			...
			throw vg.errorOccured(connection, query);
		}
	}
	...
	public boolean execute() throws KnownError {
		try {
			...
			throw vg.errExecute(connection, statement.toString(), e);
		}
	}
	...
	public DbThree setStringArray(String[] items) throws KnownError {
		try {
			...
			throw vg.errorSet(connection, query, e);
		}
		return this;
	}
...
//	}
	...
	private KnownError errorGet(SQLException e) {
		return vg.errorGet(connection, "At index:" + columnIndex + " Query:" + query, e);
	}
