...
public class TypeHolder {
	...
	public void writeJson(JSONWriter writer, DbThree db3) throws KnownError,
			KnownError {
		if(isArray() && isMap()){
	...
	public Object fromString(String val) throws KnownError, ParseException {
		if (dim > 0) {
			if (val == null)
				return null;
